...
describe PhotonClient do
  it "calls photon and gets a response" do
    expected_response = [
      ...
      Models::LocationResult.new(latitude: 51.58844725, longitude: 5.516390104700668, display_name: "Meierijstad, North Brabant, Netherlands", country_code: "NL", osm_id: 6_838_008, osm_type: "municipality", language: "en"),
