...
describe NominatimClient do
  it "calls nominatim and gets a response" do
    expected_response = [
      { latitude: -22.90173, longitude: -43.2797093, display_name: "Méier, Rio de Janeiro, Região Geográfica Imediata do Rio de Janeiro, Região Metropolitana do Rio de Janeiro, Região Geográfica Intermediária do Rio de Janeiro, Rio de Janeiro, Região Sudeste, Brasil" }
    ]
