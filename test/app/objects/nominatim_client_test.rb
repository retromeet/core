...
describe NominatimClient do
  it "calls nominatim and gets a response" do
    expected_response = [
      Models::LocationResult.new(latitude: -22.90173, longitude: -43.2797093, display_name: "Méier, Rio de Janeiro, Região Metropolitana do Rio de Janeiro, Brasil", country_code: "br", osm_id: 5_520_336)
    ]
